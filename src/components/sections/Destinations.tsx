          ...
          {DESTINATIONS.slice(0, 6).map((dest, idx) => (
            ...
            >
              <Link
                ...
                className="group block h-full overflow-hidden rounded-3xl bg-white ring-1 ring-ink-200/60 shadow-sm transition-all duration-500 hover:shadow-2xl hover:-translate-y-1 focus:outline-none focus-visible:ring-2 focus-visible:ring-saffron-400"
              ...
              >
                <div className="relative aspect-[4/3] overflow-hidden">
                  ...
                  <div className="absolute inset-x-4 bottom-4 flex items-end justify-between text-cream">
                    <h3 className="font-display text-3xl tracking-tight">{dest.name}</h3>
                    <span className="mb-1 flex h-8 w-8 items-center justify-center rounded-full bg-white/15 ring-1 ring-white/30 backdrop-blur transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5">
                ...
                <div className="p-6">
                  ...
                  <div className="mt-5 flex items-center justify-between border-t border-ink-100 pt-4">
                    ...
                    <span className="text-xs font-medium text-saffron-700 group-hover:text-saffron-800">
                      Explore →
                    </span>
                  </div>
                </div>
