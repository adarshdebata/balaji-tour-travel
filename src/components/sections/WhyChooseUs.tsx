...
export function WhyChooseUs() {
  return (
    <section className="relative py-24 lg:py-32 bg-white/50 dark:bg-white/[0.03]">
            ...
            return (
              <motion.article
                ...
                className={cn(
                  ...
                  "dark:bg-ink-900 dark:ring-white/10 dark:hover:shadow-black/40",
                )}
              >
                {/* Decorative corner */}
                <div className="absolute -right-12 -top-12 h-32 w-32 rounded-full bg-saffron-100 opacity-0 transition-opacity duration-500 group-hover:opacity-80 dark:bg-saffron-500/10" />
                ...
                <div className="relative">
                  ...
                  <h3 className="mt-6 font-display text-2xl text-ink-900 dark:text-cream">
                    {feature.title}
                  </h3>
                  ...
                  <div className="mt-6 flex items-center gap-2 text-xs uppercase tracking-[0.2em] text-saffron-700 opacity-0 transition-all duration-500 group-hover:opacity-100 dark:text-saffron-300">
                    <span>0{idx + 1}</span>
